...
TEST_CASE("CASO 1")
{
    ...
    Gimnasio->actividades[0].CantHorarios=5;//spinning
    ...
    Gimnasio->actividades[1].CantHorarios=4;//Boxeo
    ...
    Gimnasio->clientes[0]={"Hugh","Monahan","Hugh.Monahan18@gmail.com","1 (415) 935-4832",{"Spinning","","Spinning"},{12,11,1990},1,1,{1,0,3},{8,0,12}};
    ...
    SECTION("RESERVA"){
        ...
        CHECK(Gimnasio->actividades[0].cupos[0]==44);//esa es la actividad que quiero reservar
